...
class Formulaire(Frame):
    def __init__(self, fenetre, **kwargs):
        ...
        L_numcarte.grid(column=0,row=0,sticky='W',padx=spal)
        E_numcarte.grid(column=0,row=1,sticky='EW',padx=spal,pady=spal)
        L_dateEmi.grid(column=1,row=0,sticky='W',padx=spal)
        E_dateEmi.grid(column=1,row=1,sticky='EW',padx=spal,pady=spal)
        L_dateExp.grid(column=2,row=0,sticky='W',padx=spal)
        E_dateExp.grid(column=2,row=1,sticky='EW',padx=spal,pady=spal)
        ...
        L_prenoms.grid(column=2,row=0,sticky='w',padx=spal)
        E_nomn.grid(column=0,row=1,sticky='EW',padx=spal,pady=spal)
        E_nomu.grid(column=1,row=1,sticky='EW',padx=spal,pady=spal)
        E_prenoms.grid(column=2,row=1,sticky='EW',padx=spal,pady=spal)
        L_adresse.grid(column=0,row=2,sticky='w',padx=spal)
        E_adresse.grid(column=0,row=3,sticky='EW',padx=spal,pady=spal,columnspan=3)
        E_adresse2.grid(column=0,row=4,sticky='EW',padx=spal,pady=spal,columnspan=3)
        ...
        L_nomP2.grid(column=2,row=9,sticky='w',padx=spal)
        E_nomP2.grid(column=2,row=10,sticky='EW',padx=spal,pady=spal)
        ...
        E_signe.grid(column=3,row=1,sticky='EW',padx=spal,pady=spal)
        E_signe2.grid(column=3,row=2,sticky='EW',padx=spal,pady=spal)
        
        F_carte.grid(column=0,row=0,sticky='EW',padx=spaf,pady=spaf)
        F_ID.grid(column=0,row=1,sticky='EW',padx=spaf,pady=spaf)
    ...
    def update_data(self,personne=None):
        if personne == None:
            ...
            self.V_nomP1.set("")
            self.V_nomP2.set("")
            self.V_extrait1.set("Extrait Acte de Naissance n°")
            self.V_extrait2.set("Suivant déclaration du")
            self.V_extrait3.set("")
